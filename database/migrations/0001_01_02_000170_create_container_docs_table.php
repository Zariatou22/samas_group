...
/**
 * Reprend le schema exact de la table `container_docs` de la base legacy SAMAS
...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('container_docs')) {
            return;
        }
...
SQL);
    ...
    {
        Schema::dropIfExists('container_docs');
    }
};
