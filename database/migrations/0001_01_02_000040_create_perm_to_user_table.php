...
/**
 * Reprend le schema exact de la table `perm_to_user` de la base legacy SAMAS
...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('perm_to_user')) {
            return;
        }
...
SQL);
    ...
    {
        Schema::dropIfExists('perm_to_user');
    }
};
