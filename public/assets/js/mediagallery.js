(function($) {
	...
	Thumbnail: Select
	*/
	$('.media-gallery').on('change', '.mg-option input[type=checkbox]', function( ev ) {
	...
	Toolbar: Select All
	*/
	$('.media-gallery').on('click', '#mgSelectAll', function( ev ) {
		ev.preventDefault();
		var $this = $(this),
	...
	*/
	...
	$('.media-gallery').on('click.lightbox', '.thumb-preview .mg-zoom', function( ev ) {
		ev.preventDefault();
