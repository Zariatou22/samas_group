...
<head>
    ...
    <title>Configurer l'OTP - SAMAS Groupe</title>
...
<body>
    <section class="login-block">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <form class="md-float-material form-material" method="POST" action="{{ route('login-otp.setup') }}">
                        @csrf
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center">Configurer l'OTP</h3>
                                        <p class="text-center text-muted">Régénère le code QR à scanner avec une application d'authentification. Attention : cela invalide la configuration précédente pour tout le monde.</p>
                                    </div>
                                </div>
                                ...
                                <div class="text-center">
                                    <a href="{{ route('login-otp.show') }}">Retour</a>
                                </div>
                            </div>
                        </div>
                    </form>
